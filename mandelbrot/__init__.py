"""Mandelbrot v7.2.1 - pacchetto (ex mandel.py single-file).
...
HISTORY = (
    ("7.2.1", "2026-09-04", "Benchmark senza hang infinito: timeout Metal 30 s (completed-handler con deadline invece di waitUntilCompleted bloccante; i valori status() grezzi non sono stabili tra versioni macOS) + deadline per-rendering (Metal 35 s, CPU 180 s); esiti/ambiente del benchmark in ~/mandelbrot/bench.log; Help Informazioni mostra l'OS."),
